    ...
    return (function (className) {
        $.each($('label.' + className), function (i, val) {
            ...
            function artCheckBoxProcess() {
                ...
                if (ch.length) {
                  if (label.hasClass('css-checked')) {
                    ch.removeAttr('checked');
                    label.removeClass('css-checked');
                  }
                  else {
...
var ThemeLightbox = (function ($) {
    ...
    return (function () {
        ...
        this.init = function (ctrl) {
            $(".css-lightbox").live("click", { _ctrl: ctrl }, function (e) {
            ...
            $(".css-lightbox-wrapper .arrow.left:not(.disabled)").live("click", function () {
                move(current - 1);
            });

            $(".css-lightbox-wrapper .arrow.right:not(.disabled)").live("click", function () {
                move(current + 1);
            });

            $(".css-lightbox-wrapper .active").live("click", function () {
                move(current + 1);
            });

            $(".css-lightbox-wrapper .close").live("click", function () {
                close();
            });
        };
        ...
        function show(src) {
            ...
            var img = $('<img class="css-lightbox-image active" src="' + getFullImgSrc($(src).attr("src")) + '">');
            ...
            bindMouse($(".css-lightbox-wrapper .arrow").add(img).add(imgContainer));
        }
        ...
        function showArrows() {
            if ($(".css-lightbox-wrapper .arrow").length === 0) {
                $(".css-lightbox-wrapper").append($('<div class="arrow left"><div class="arrow-t ccw"> </div><div class="arrow-b cw"> </div><div class="arrow-left-alt">&#8592;</div></div>').css("top", $(window).height() / 2 - 40));
                $(".css-lightbox-wrapper").append($('<div class="arrow right"><div class="arrow-t cw"> </div><div class="arrow-b ccw"> </div><div class="arrow-right-alt">&#8594;</div></div>').css("top", $(window).height() / 2 - 40));
            }
...
jQuery(window).bind("resize", (function ($) {
    ...
    return function () {
        if (typeof responsiveDesign !== "undefined" && responsiveDesign.isResponsive) {
            $("header.css-header .css-shapes").children().css("left", "");
            return;
        }
        var sheetWidth = $(".css-sheet").width();
        var sheetLeft = $(".css-sheet").offset().left;
        $("header.css-header .css-shapes>*, header.css-header>.css-textblock, header.css-header>.css-headline, header.css-header>.css-slogan").each(function () {
            var object = $(this);
